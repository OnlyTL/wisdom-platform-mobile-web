...
export const spacing = {
  // tips: 添加逻辑 key= px值/4   rem值转换 https://www.toolkk.com/tools/px-rem-converter
  0.25: '0.0625rem', // 1px
  4.5: '1.125rem', //18px
  7: '1.75rem', // 28px
  7.5: '1.875rem', // 30px
 ...
 */
export const colors = {
  primary: 'var(--van-primary-color)', //#02C68A 主色  ,
  'gray-1': 'var(--van-gray-1)', // '#F7F8FA' 背景色,
  'gray-2': 'var(--van-gray-2)', // '#f2f3f5' 背景色,
  'gray-3': 'var(--van-gray-3)', // '#ebedf0' 边框、线色,
  'gray-4': 'var(--van-gray-4)', // '#dcdee0' 翻页器、下拉选择、步骤条线色,
  'gray-5': 'var(--van-gray-5)', // '#c8c9cc' 禁用、提示文字等,
  'gray-6': 'var(--van-gray-6)', // '#969799' 辅助、说明文字,
  'gray-7': 'var(--van-gray-7)', // '#646566' 次文字,
  'gray-8': 'var(--van-gray-8)' // '#323233' 主文字
}

/**
 * 白名单 如果 className 在白名单中，则不会被 purge 掉
 */
